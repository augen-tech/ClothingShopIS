...
@section('pageWrapper')
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">{{ isset($brand) ? "Form Edit Branch" : "Form New Brand" }}</h3>                      
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">{{ isset($brand) ? "Edit Brand" : "Add New Brand" }}</h4>
                                <form class="form-material m-t-40" action="{{ isset($brand) ? route('superadmin.brand.update', $brand->id)  : route('superadmin.admin.store') }}" method="POST" > 
                                @csrf
